...
- Map a domain to a language, the language to a grammar, and the grammar to a hierarchical object-oriented desig
...
Examples
used exaustively in defining grammars, tokenize input and store it.
rules engines.
to add functionality to the composite pattern.
